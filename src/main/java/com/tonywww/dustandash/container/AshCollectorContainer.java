...
public class AshCollectorContainer extends Container {

    private final TileEntity tileEntity;
    private final IWorldPosCallable canInteractWithCallable;
    private final IItemHandler playerInventory;

    public AshCollectorContainer(int id, PlayerInventory playerInventory, AshCollectorTile tileEntity) {
        super(ModContainers.ASH_COLLECTOR_CONTAINER.get(), id);
